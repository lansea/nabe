...
module.exports = {
  ...
  // ### port
  // server port, locally it doesn't matter much. Depending on where you are planning
  // on deploying it, you'll certainly want to change this.
  port: 9606,
  ...
  github: {
    ...
    // fill in your github user account
    user: 'mklabs',
