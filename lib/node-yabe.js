...
//**util module, more on this [util](util.html)**
util = require('./routes'),

//**admin layer, more on this [here](ext/admin.html)**
admin = require('./ext/admin'),

//**pages layer, more on this [here](ext/pages.html)**
pages = require('./ext/pages'),

//**github layer, more on this [here](ext/github.html)**
...
nabe.use(connect.logger())
  ...
  .use(connect.static(path.join(process.cwd(), config.themeDir, config.theme, 'public'), {
...
// Even better, sync methods in node throw exceptions, and async method pass the error
